...
library PancakeLibrary {
    ...
    function pairFor(address factory, address tokenA, address tokenB) internal pure returns (address pair) {
        ...
        pair = address(uint(keccak256(abi.encodePacked(
                ...
                hex'4b2f8c7bf3ce385b68176cff69beba505a33d30310e74f06593c87b133b041ec' // init code hash
            ))));
    }
...
contract RareSwapRouter is IPancakeRouter02 {
    using SafeMath for uint;
        ...
        ensure(deadline)
    {
        ...
        require(amountOut >= amountOutMin, 'RareSwapRouter: INSUFFICIENT_OUTPUT_AMOUNT');

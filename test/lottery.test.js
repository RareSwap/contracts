...
contract('Lottery', (accounts) => {
    it('init', async () => {
        ...
        this.rare = await MockBEP20.deployed();
        ...
        await this.rare.transfer(bob, '2000', { from: minter });
        await this.rare.transfer(alice, '2000', { from: minter });
        await this.rare.transfer(carol, '2000', { from: minter });
    });
    ...
    it('test', async () => {
        ...
        carol=accounts[3];
        dev=accounts[4];
        await this.rare.approve(this.lotteryProxyAddress, '1000', { from: alice });
        await this.rare.approve(this.lotteryProxyAddress, '1000', { from: bob });
        ...
        assert.equal((await this.rare.balanceOf(this.lotteryProxyAddress)).toString(), '418');
